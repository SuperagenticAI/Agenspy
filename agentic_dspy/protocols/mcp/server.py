"""MCP Server implementation for Agentic-DSPy."""  
...
class MCPServer(BaseProtocol):  
    ...
    def register_tool(self, name: str, description: str, handler: Callable, parameters: Optional[Dict[str, Any]] = None):  
    ...
    def register_context_provider(self, provider: Callable):  
        ...
        print(f"📝 Registered context provider")  
    ...
    def _handle_request(self, **kwargs) -> dspy.Prediction:  
        ...
        if request_type == 'status':  
            ...
            return dspy.Prediction(  
                ...
                protocol_info="MCP server error response"  
            )  
...
class MockMCPServerInstance:  
    ...
    def stop(self):  
        ...
        self.running = False  
        print(f"Mock MCP server stopped")